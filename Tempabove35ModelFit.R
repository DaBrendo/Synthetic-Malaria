...
# LM
lm1 <- lm(cpt ~ tabove35LAG2W + Region, data = mal2W)
names(lm1)
# RMSE estimate
...
lm2 <- lm(cpt ~ tabove35LAG2W * Region, data = mal2W)
names(lm2)
# RMSE estimate
...
# LM
lm1 <- lm(cpt ~ tabove35LAG4W + Region, data = mal4W)
names(lm1)
# RMSE estimate
...
lm2 <- lm(cpt ~ tabove35LAG4W * Region, data = mal4W)
names(lm2)
# RMSE estimate
...
lm2 <- lm(cpt ~ tabove35LAG8W * Region, data = mal8W)
names(lm2)
# RMSE estimate
